...
--local lowestHp = 0.09 -- absolute lowest hp can drain (don't make it kill you please, I'm beggin ya)  | Weird, may try to improve some time
	...
	if ENABLED == true then
		...
		if swapDirections == true then
			...
			if rotatIconBf == true then
				...
				setProperty('iconP1.origin.y', 110) -- not perfect, but better than leaving it
			...
			if rotatIconBf == true then
				...
				setProperty('iconP1.origin.y', 50) -- not perfect, but better than leaving it
				setProperty('iconP1.y', P1Mult - 100)
			else
				setProperty('iconP1.x', getProperty('healthBar.x') + 220)
				setProperty('iconP1.origin.y', -110) -- stops weird icon bop
				setProperty('iconP1.y', P1Mult)
			end
